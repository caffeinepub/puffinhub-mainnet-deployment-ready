...
import { useUnifiedIdentity, type IdentityProvider } from '../hooks/useUnifiedIdentity';
      ...
      <DialogContent className="sm:max-w-md bg-white dark:bg-slate-900 border-2 border-primary/30">
        ...
        <div className="relative z-10 flex flex-col gap-4 py-4">
          ...
          >
            <div className="flex items-center justify-center">
              <div className="text-center">
                <h3 className="text-lg font-bold text-foreground">Official Internet Identity</h3>
                <p className="text-sm text-foreground/70 mt-1">identity.ic0.app</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center justify-center">
              <div className="text-center">
                <h3 className="text-lg font-bold text-foreground">AI Identity</h3>
        ...
        {isLoggingIn && (
          <div className="relative z-10 text-center">
            <p className="text-sm text-foreground/70">Connecting to identity provider...</p>
          </div>
        )}
      </DialogContent>
    </Dialog>
