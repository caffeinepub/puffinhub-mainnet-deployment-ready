...
export default function FlightAdventureGame({ onBack }: FlightAdventureGameProps) {
  ...
  const checkCollision = (puffin: { x: number; y: number }, obstacle: Obstacle) => {
    return (
  ...
  const gameLoop = () => {
    ...
    if (distanceRef.current % SPEED_INCREMENT_INTERVAL === 0 && distanceRef.current > 0) {
  ...
  const handleKeyDown = (e: KeyboardEvent) => {
    ...
    if (!gameStarted && showPreGameOverlay && (key === 'ArrowUp' || key === 'w' || key === ' ')) {
    ...
    <div className="container py-12">
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold md:text-4xl">Puffin Flight Adventure</h1>
            <p className="mt-2 text-muted-foreground">
              Fly through clear skies and cliffs! Use arrow keys, W, or spacebar to fly up.
            </p>
          </div>
        </div>
              ...
              {showPreGameOverlay && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-lg">
                  <div className="bg-background border-4 border-primary rounded-lg p-8 max-w-md text-center shadow-2xl">
                    <h2 className="text-2xl font-bold mb-4 text-primary">Ready to Fly?</h2>
                    <p className="text-lg mb-2">
                      Press <strong className="text-accent">↑ (Up Arrow)</strong>, <strong className="text-accent">W</strong>, or <strong className="text-accent">Spacebar</strong>
                    </p>
                    <p className="text-lg">
                      to flap and fly upward.
                    </p>
                  </div>
                </div>
              )}
          ...
          {gameOver && showNameInput && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your score: {score}. Submit your score to the leaderboard!</CardDescription>
              </CardHeader>
          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-4 pt-4">
              <p className="text-base">
                Use <strong>arrow keys</strong> to fly. Avoid obstacles and stay in the air as long as possible to earn points.
              </p>
              <ul className="list-disc list-inside space-y-2 text-base">
                <li>Press <strong>↑ (Up Arrow)</strong>, <strong>W</strong>, or <strong>Spacebar</strong> to flap and fly upward</li>
                <li>Avoid hitting <strong>cliffs</strong></li>
