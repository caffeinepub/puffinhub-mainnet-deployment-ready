...
export default function ConnectedWalletSection() {
  ...
  const accountId = walletInfo.principal
    ? principalToAccountId(walletInfo.principal)
    : "";
  ...
  const handleSendClick = () => {
    ...
    if (recipientValidation === "invalid") {
      toast.error("Invalid recipient format", {
        description:
          "Must be either a Principal ID (with hyphens) or a 64-character hexadecimal Account ID",
        duration: 5000,
      });
      return;
    }
  ...
  const handleConfirmTransaction = async () => {
    ...
    setIsSending(true);
    try {
      const amountICP = Number.parseFloat(pendingTransaction.amount);
          ...
          {!walletInfo.isConnected ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Connect your Plug Wallet to send ICP directly without backend
                deployment
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.value && (Number.isNaN(num) || num <= 0)) {
                ...
                <Button
                  ...
                  disabled={
                    !recipient || !amount || !!validationError || isSending
                  }
