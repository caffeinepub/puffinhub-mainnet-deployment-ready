              ...
              <div className="mx-auto max-w-4xl">
                <div className="mb-8 flex items-center gap-4">
                  <Button
                    ...
                    className="border-2 border-primary/40 transition-all duration-300 hover:border-primary/60"
                  >
              ...
              <div className="mx-auto max-w-6xl">
                <div className="mb-12 text-center">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Choose your adventure and help Puffin on exciting
                    challenges!
                  </p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("flightAdventure")}
                  >
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Navigate through clear skies and cliffs in this
                        side-scrolling challenge
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
                      <Button
                        className="group/btn relative w-full overflow-hidden bg-gradient-to-r from-primary to-[oklch(0.70_0.18_245)] shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-primary/50"
                        size="lg"
                      >
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("fishFrenzy")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Dive underwater and catch fish while avoiding killer
                        fish
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("puffinRescue")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Navigate arctic terrain to rescue lost puffin chicks
                        across 5 levels
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("arcticSurf")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Ride ice floes across arctic waters and jump between
                        floating ice
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("puffinCatch")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("puffinTowerDefense")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Build puffin towers to defend your eggs from waves of
                        enemies
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
                  ...
                  <Card
                    className="group relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 cursor-pointer"
                    onClick={() => setCurrentMode("puffinColonyWars")}
                  >
                    <div className="absolute inset-0 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <img
                        src="/assets/generated/wave-motion-overlay-transparent.dim_400x150.png"
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription className="text-center">
                        Build your puffin army and destroy the enemy colony in
                        this strategy game
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="relative">
