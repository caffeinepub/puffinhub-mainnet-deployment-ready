 ...
 */
export function principalToAccountId(principal: Principal, subAccount?: Uint8Array): string {
  ...
  const data = new Uint8Array(domainSeparator.length + principalBytes.length + subAccountBytes.length);
