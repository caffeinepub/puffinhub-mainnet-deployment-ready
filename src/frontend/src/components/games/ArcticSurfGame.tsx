  ...
  const gameLoop = () => {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      for (let x = 0; x < CANVAS_WIDTH; x += 20) {
        const y =
          WATER_LEVEL +
          Math.sin((x + distanceRef.current * 2 + i * 50) / 30) * 5;
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Ride ice floes across arctic waters! Press spacebar or up arrow to
              jump.
            </p>
          </div>
        </div>
          ...
          {gameOver && showNameInput && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  You fell into the water! Your score: {score}
                </CardDescription>
              </CardHeader>
          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-4 pt-4">
              <p className="text-base">
                Use <strong>arrow keys</strong> to surf and{" "}
                <strong>spacebar</strong> to jump between ice floes. Ride as far
                as you can without falling into the water!
              </p>
              <ul className="list-disc list-inside space-y-2 text-base">
                <li>
                  Press <strong>Spacebar</strong> or{" "}
                  <strong>↑ (Up Arrow)</strong> to jump between ice floes
                </li>
                <li>
                  Land on the <strong>light blue ice floes</strong> to stay safe
                </li>
                <li>
                  <strong>Avoid obstacles</strong> like seals and rocks on the
                  ice!
                </li>
                <li>
                  <strong>Don't fall into the water</strong> - it ends your
                  game!
                </li>
