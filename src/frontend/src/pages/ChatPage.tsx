...
const OPENROUTER_API_KEY =
  "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";
...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    if (savedMessages) {
      ...
      const welcomeMessage: Message = {
        ...
        role: "assistant",
        content:
          "Hello! I'm your friendly Puffin companion! 🐧 Ask me anything, and I'll do my best to help you!",
        timestamp: Date.now(),
      };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (userMessageContent.length > MAX_PROMPT_LENGTH) {
      alert(
        `Your message is too long! Please keep it under ${MAX_PROMPT_LENGTH} characters. Current length: ${userMessageContent.length}`,
      );
    ...
    if (timeSinceLastRequest < RATE_LIMIT_MS) {
      ...
      alert(
        `Please wait ${waitTime} more second${waitTime > 1 ? "s" : ""} before sending another message.`,
      );
      return;
    }
      ...
      <div className="container relative z-10 py-8 md:py-12">
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="relative overflow-hidden border-2 border-primary/40 bg-gradient-to-br from-[oklch(0.75_0.15_200)]/20 via-background to-primary/5 shadow-2xl">
            ...
            <ScrollArea
              ref={scrollAreaRef}
              className="h-[500px] md:h-[600px] p-6"
            >
                    ...
                    >
                      {message.role === "assistant" && (
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs font-semibold ${message.isError ? "text-destructive" : "text-primary"}`}
                          >
