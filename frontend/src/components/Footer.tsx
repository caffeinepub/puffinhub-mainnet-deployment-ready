      ...
      <div className="container relative z-10 py-8">
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            © 2025. Built with <Heart className="inline h-4 w-4 text-accent" fill="currentColor" /> using{' '}
            <a href="https://caffeine.ai" target="_blank" rel="noopener noreferrer" className="text-primary transition-colors hover:text-primary/80 hover:underline">
              caffeine.ai
            </a>
          </p>
        </div>
