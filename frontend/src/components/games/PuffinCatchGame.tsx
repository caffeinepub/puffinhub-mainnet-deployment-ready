...
import { RotateCcw, ArrowLeft, Trophy, Info } from 'lucide-react';
...
export default function PuffinCatchGame({ onBack }: PuffinCatchGameProps) {
  ...
  const checkCollision = (puffin: { x: number; y: number }, item: FallingItem) => {
    return (
  ...
  const gameLoop = () => {
    ...
    const spawnRate = Math.max(30, 60 - Math.floor(difficultyTimerRef.current / 5000) * 5);
            ...
            <div className="relative flex justify-center bg-muted p-4">
              ...
              {!isGameActive && !gameOver && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/40 rounded-lg">
                  <Button size="lg" onClick={initGame} className="gap-2 shadow-2xl">
          ...
          {gameOver && showNameInput && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>You hit trash! Your score: {score}</CardDescription>
              </CardHeader>
          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-4 pt-4">
              <p className="text-base">
                Use <strong>arrow keys</strong> to fly and catch falling fish. Avoid trash items - one hit and you're out!
              </p>
              <ul className="list-disc list-inside space-y-2 text-base">
                <li>Use <strong>↑↓←→ (Arrow Keys)</strong> or <strong>WASD</strong> to fly in all directions</li>
                <li>Catch <strong>orange fish</strong> to earn <strong>10 points</strong> each</li>
                <li><strong>Avoid red cross hazard boxes</strong> - one hit ends the game!</li>
                <li>The game gets harder over time with more hazards and faster falling items!</li>
              </ul>
            </DialogDescription>
          </DialogHeader>
