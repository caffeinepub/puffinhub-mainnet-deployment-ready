    ...
    <div className="w-full">
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-30">
          <div className="absolute left-[5%] top-[15%] h-64 w-64 animate-pulse rounded-full bg-[oklch(0.75_0.15_200)] blur-3xl" />
          <div
            className="absolute right-[10%] top-[40%] h-80 w-80 animate-pulse rounded-full bg-[oklch(0.70_0.12_180)] blur-3xl"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute left-[15%] bottom-[20%] h-72 w-72 animate-pulse rounded-full bg-primary/20 blur-3xl"
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row md:items-center md:justify-center">
              ...
              <div className="relative flex-shrink-0">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[oklch(0.75_0.15_200)]/20 via-[oklch(0.70_0.12_180)]/15 to-primary/5 blur-2xl" />
                  <img
              ...
              <div className="text-center md:text-left">
                ...
                <p className="mb-8 text-xl text-muted-foreground md:text-2xl">
                  Your friendly ocean companion! Dive into a world of fun with
                  Puffin, the most adorable mascot around. Join our community,
                  share amazing moments, and play exciting games with fellow
                  Puffin fans! 🐧
                </p>
                <div className="flex flex-wrap justify-center gap-4 md:justify-start">
                  <Link to="/gallery">
                    <Button
                      size="lg"
                      className="group/btn relative gap-2 overflow-hidden bg-gradient-to-r from-primary to-[oklch(0.70_0.18_245)] shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-primary/50"
                    >
                  ...
                  <Link to="/game">
                    <Button
                      size="lg"
                      variant="outline"
                      className="gap-2 border-2 border-primary/40 transition-all duration-300 hover:border-primary/60 hover:shadow-lg"
                    >
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-muted-foreground md:text-xl">
                Join the bonding process and be part of the Puffin coin launch
                ...
                <Card className="relative overflow-hidden border-2 border-primary/40 bg-gradient-to-br from-[oklch(0.75_0.15_200)]/20 via-background to-primary/5 shadow-xl transition-all duration-300 hover:border-primary/60 hover:shadow-2xl hover:-translate-y-1">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-primary/30 bg-gradient-to-br from-[oklch(0.75_0.15_200)]/10 to-background p-6 backdrop-blur-sm shadow-inner">
                      <div className="absolute right-0 top-0 h-24 w-24 -translate-y-8 translate-x-8 rounded-full bg-primary/15 blur-2xl" />
                      ...
                      <div className="relative space-y-2">
                        ...
                        <p className="text-sm leading-relaxed text-muted-foreground">
                          Join the ICP bonding phase and secure your Puffin
                          coins on the Internet Computer blockchain. Be part of
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-gradient-to-r from-primary/10 to-accent/10 px-6 py-3 backdrop-blur-sm">
                ...
                <p className="text-sm font-medium">
                  🌊 Dive into the bonding phase and become an early supporter
                  of Puffin Coin! 🐧
                </p>
              </div>
            </div>
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-12 text-lg text-muted-foreground">
              Puffins are charming, loyal, and love to dive deep into the ocean.
              Just like our mascot, we bring joy, friendship, and fun to
              everyone who joins our community!
            </p>
            <div className="grid gap-6 md:grid-cols-3">
              <Card className="group relative overflow-hidden border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1">
                ...
                <CardContent className="relative pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Built by friends, for friends. Every member of our flock
                    matters!
                  </p>
                </CardContent>
              </Card>
              <Card className="group relative overflow-hidden border-2 border-accent/20 bg-gradient-to-br from-accent/5 to-background transition-all duration-300 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/20 hover:-translate-y-1">
                ...
                <CardContent className="relative pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Share memes, play games, and have a blast with fellow Puffin
                    lovers!
                  </p>
                </CardContent>
              </Card>
              <Card className="group relative overflow-hidden border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-background transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1">
                ...
                <CardContent className="relative pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Play our puffin arcade and compete with other community
                    members!
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-25">
          <div className="absolute left-[10%] top-[20%] h-64 w-64 animate-pulse rounded-full bg-[oklch(0.75_0.15_200)] blur-3xl" />
          <div
            className="absolute right-[15%] bottom-[25%] h-72 w-72 animate-pulse rounded-full bg-accent/20 blur-3xl"
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
              ...
              <div className="group relative overflow-hidden rounded-lg border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background p-6 shadow-md transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-1">
                ...
                <div className="relative">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Share your favorite Puffin moments! Upload and browse
                    through an amazing collection of Puffin-themed GIFs created
                    by our community.
                  </p>
                  <Link to="/gallery">
                    <Button
                      variant="outline"
                      className="w-full border-2 border-primary/40 transition-all duration-300 hover:border-primary/60"
                    >
                      Explore Gallery
                    </Button>
                  </Link>
              ...
              <div className="group relative overflow-hidden rounded-lg border-2 border-accent/30 bg-gradient-to-br from-accent/10 to-background p-6 shadow-md transition-all duration-300 hover:border-accent/50 hover:shadow-xl hover:shadow-accent/20 hover:-translate-y-1">
                ...
                <div className="relative">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Take control of our adorable Puffin! Fly through the ocean,
                    collect fish, and see how high you can score in these fun
                    arcade games.
                  </p>
                  <Link to="/game">
                    <Button
                      variant="outline"
                      className="w-full border-2 border-accent/40 transition-all duration-300 hover:border-accent/60"
                    >
                      Start Playing
                    </Button>
                  </Link>
              ...
              <div className="group relative overflow-hidden rounded-lg border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background p-6 shadow-md transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-1">
                ...
                <div className="relative">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Command your puffin colony in epic battles! Build units,
                    upgrade your base, and defend your nest in this strategic
                    lane-push game.
                  </p>
              ...
              <div className="group relative overflow-hidden rounded-lg border-2 border-accent/30 bg-gradient-to-br from-accent/10 to-background p-6 shadow-md transition-all duration-300 hover:border-accent/50 hover:shadow-xl hover:shadow-accent/20 hover:-translate-y-1">
                ...
                <div className="relative">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Defend your territory from waves of enemies! Place strategic
                    towers, upgrade defenses, and protect your puffin colony.
                  </p>
      ...
      <section className="relative overflow-hidden py-16 md:py-24 border-y border-border">
        ...
        {/* Soft gradient orbs */}
        <div className="absolute inset-0 overflow-hidden opacity-25">
          <div className="absolute left-[8%] top-[18%] h-72 w-72 animate-pulse rounded-full bg-[oklch(0.75_0.15_200)] blur-3xl" />
          <div
            className="absolute right-[12%] bottom-[22%] h-80 w-80 animate-pulse rounded-full bg-accent/20 blur-3xl"
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
                Have a conversation with our friendly Puffin mascot! Ask
                questions, get advice, or just chat about your day. 🐧💬
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-background p-8 shadow-xl transition-all duration-300 hover:border-primary/50 hover:shadow-2xl hover:-translate-y-1">
              ...
              <div className="relative text-center space-y-6">
                <p className="text-lg text-muted-foreground">
                  Start a conversation with Puffin and discover helpful tips,
                  fun facts, and friendly advice from your favorite ocean
                  companion!
                </p>
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              Ready to waddle into the world of Puffin? Explore our GIF gallery,
              play our arcade games, and become part of the friendliest
